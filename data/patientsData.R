P1 <- list(
  ...
  time_echelle = c(0,5,30,35,46) * 300,
  sfcs_well = c(3,29,25,25,9), # Table 3
  sfcs_well_echelle = c(3,29,25,25,9)/2500, # Table 3
...
P4 <- list(
  ...
  time_echelle = c(0,6,9,18,24,32,34,42) * 300,
  sfcs_well = c(1,16.5,33,30,26,11,15,12),
  sfcs_well_echelle = c(1,16.5,33,30,26,11,15,12)/2500,
  y0_0 = 2.4e-6,
  n = 2.2, # Ancienement 1.2
  d_t = 0.0022,
  s_t = 9e-7,
  c_n = 7
)
...
P12 <- list(
  ...
  time_echelle = c(0,2,5,9,13,15,24,30) * 300,
  sfcs_well = c(11,42,39,71,36.5,43,5,6),
  sfcs_well_echelle = c(11,42,39,71,36.5,43,5,6)/2500,
  y0_0 = 1.2e-5,
  n = 1.17,
  d_t = 0.007,
  s_t = 3.08e-5,
