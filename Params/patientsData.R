P1 <- list(
  ...
  time_month = c(0,30,35,46), # Table 3
  sfcs_well = c(3,29,2525,9), # Table 3
  y_0_0 = 7.6e-6, # Initial concentration of leukemia stem cells, Table 6
...
P4 <- list(
  ...
  time_month = c(0,6,9,18,24,32,34,42),
...
P12 <- list(
  ...
  time_month = c(0,2,5,9,13,15,24,30),
